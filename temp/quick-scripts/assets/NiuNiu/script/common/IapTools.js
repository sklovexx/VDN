(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/NiuNiu/script/common/IapTools.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '8931ckxYbhIdaBvpbEduuhE', 'IapTools', __filename);
// NiuNiu/script/common/IapTools.js
...
IapTools.restorePurchase = function (sucCallback, failedCallback) {
    ...
    if (cc.sys.platform === cc.sys.IPHONE || cc.sys.platform === cc.sys.IPAD) {
        ...
        _ret = jsb.reflection.callStaticMethod("org/cocos2dx/javascript/AppActivity", "restorePurchase", "()Ljava/lang/String;");
        cc.log('restore suc ret:' + _ret);
        var _ret = JSON.parse(_ret);
        cc.log(_ret.length);
    } else {}
...
cc._RF.pop();
        ...
        //# sourceMappingURL=IapTools.js.map
