(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/NiuNiu/script/net/socket/GameNetwork.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '6d3b90F1ltPQqEXXz0L8FEx', 'GameNetwork', __filename);
// NiuNiu/script/net/socket/GameNetwork.js
...
var GameNetwork = cc.Class({
    ...
    offCallback: function offCallback(act, callback) {
     ...
     */
    _sendSocketRequest: function _sendSocketRequest(req) {
