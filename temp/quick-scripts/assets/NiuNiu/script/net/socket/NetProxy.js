(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/NiuNiu/script/net/socket/NetProxy.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '5c22dewAxJE+aRwAPMkEflJ', 'NetProxy', __filename);
// NiuNiu/script/net/socket/NetProxy.js
...
var playerData = require("./../../Common/DataMgr").getInstance().playerObj;

var GAME_SERVER_URL = 'ws://8.210.235.222:3005/ws';
...
var NetProxy = cc.Class({
    ...
    offPush: function offPush(key, cb) {
    ...
    enterRoom: function enterRoom(rid, cb) {
        var req = new GameProtocols.EnterRoomRequest();
        req.rid = rid;
        req.uid = playerData.uid;
        this.network.sendRequest(req, cb);
    },
    quitRoom: function quitRoom(rid, cb) {
        var req = new GameProtocols.QuitRoomRequest();
        req.rid = rid;
        req.uid = playerData.uid;
        this.network.sendRequest(req, cb);
    },
    startGame: function startGame() {
        var req = new GameProtocols.StartGameRequest();
        req.uid = playerData.uid;
        this.network.sendRequest(req);
    },
    ready: function ready(callback) {
        var req = new GameProtocols.ReadyRequest();
        req.uid = playerData.uid;
        this.network.sendRequest(req, callback);
    },
    config: function config() {
        console.log(1);
        var req = new GameProtocols.ConfigRequest();
        this.network.sendRequest(req);
    },
    kick: function kick() {
        var req = new GameProtocols.KickRequest();
        req.uid = playerData.uid;
        this.network.sendRequest(req);
    },
    payBet: function payBet(bet) {
        var req = new GameProtocols.BetRequest();
        req.uid = playerData.uid;
        req.bet = bet;
        this.network.sendRequest(req);
    },
