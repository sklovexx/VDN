...
//-------------------------------------------------------
let countRewardResponse = cc.Class({
    extends: BaseResponse,
    ctor(){
        this.countReward = [];
    }
...
//-------------------------------------------------------
let ConfigRequest = cc.Class({
    extends: BaseRequest,
    ctor(){
        this.act = "config";
    }
});
let ConfigResponse = cc.Class({
    extends: BaseResponse,
    ctor(){
        this.config = [];
    }
...
let StartGameResponse = cc.Class({
    extends: BaseResponse,
    ctor(){
        this.act = "startGame";
    }
...
//-------------------------------------------------------
let ReadyRequest = cc.Class({
    extends: BaseRequest,
    ctor(){
        this.act = "gameReady";
    }
});
let ReadyResponse = cc.Class({
    extends: BaseResponse,
    ctor(){
        this.act = "gameReady";
    }
});
let OtherReadyResponse = cc.Class({
    extends: BaseResponse,
    ctor(){
        this.act = "otherReady";
        this.user = null;
