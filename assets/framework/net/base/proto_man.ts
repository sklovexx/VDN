...
export default class proto_man {
    ...
    static encode_cmd(proto_type, stype, ctype, body) {
        ...
        return this.packData(body);
    }

    static packData(dataJson:any):any {
        ...
        var md5Index = parseInt(Math.random() * 4);
        var md5key = md5(md5List[md5Index] + JSON.stringify(dataJson));
        var datas = {
            index: md5Index.toString(),
            key: md5key,
