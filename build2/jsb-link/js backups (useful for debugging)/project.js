...
AnnouncementPanel: [ function(e, t, n) {
"use strict";
cc._RF.push(t, "40d07OrtaBDBoEUAzUAYGkk", "AnnouncementPanel");
cc.Class({
...
onEnable: function() {
var e = this;
Global.ProtocolMgr.queryGetMessage(function(t) {
200 == t.code ? function() {
var n = t.data;
e.container_email.removeAllChildren();
for (var i = function(t) {
var i = cc.instantiate(e.emailItem);
i.getComponent("emailItem").setData(n[t], 2);
i.on(cc.Node.EventType.TOUCH_END, function() {
Global.PageMgr.onOpenPage(20);
Global.PageMgr.pages[20].getComponent("EmailDetailPanel").setData(n[t], 2);
});
...
e._availableCoinOne = t.data.availableCoinOne;
}
});
},
...
Global.ProtocolMgr.queryGameList(1, 2, function(t) {
if (200 == t.code) {
for (var i = t.data, a = 0; a < i.length; a++) if (null == e || 0 != i[a].is_true) {
var o = cc.instantiate(n.game_item2);
o.getComponent("game_item").setData(i[a], n.goEnterGamePanel);
n.container2.addChild(o);
}
...
n.lable_gold.string = cc.js.formatStr("%s张", parseFloat(n._availableCoinOne).toFixed(3));
...
this.dianjiSum += 1;
if (this._availableCoinOne >= this.dianjiSum * (parseInt(1e3 * this.datas.ticket) / 1e3)) this.lable_sum.string = "" + this.dianjiSum; else {
...
var e = this;
if (this.dianjiSum <= 0) Global.PageMgr.showTipPage("门票不能小于1"); else if (this._availableCoinOne < this.dianjiSum * (parseInt(1e3 * this.datas.ticket) / 1e3)) Global.PageMgr.showTipPage("门票不足请购买门票"); else {
var t = {
...
console.log(t);
if (3001 != t.code) {
var n = cc.js.formatStr("1,%s,%s", e.datas2.game_package_name, e.datas2.game_web_link);
jsb.reflection.callStaticMethod("org/cocos2dx/javascript/AppActivity", "openApp", "(Ljava/lang/String;)Z", n) && e.breakPanle(null, 0);
} else Global.PageMgr.showTipPage(t.message);
});
}
}
...
buy: function() {
window.DEFAULT_availableUsdt >= parseInt(this.datas.crystal_quantity) ? Global.PageMgr.pages[8].getComponent("ArderPanel").goGamePanelUI(this.datas, this.propId) : Global.PageMgr.showTipPage(cc.js.formatStr("PMV不足%s", parseFloat(this.datas.crystal_quantity).toFixed(1)));
}
});
cc._RF.pop();
}, {} ],
...
e.label_Usdt.string = t.data.totalUsdt;
e.label_nengliang.string = parseFloat(t.data.availableCoinTwo).toFixed(4);
e.label_PMV.string = parseFloat(t.data.availableCoinOne).toFixed(4);
e.label_shenfu.string = parseFloat(t.data.totalCoinThree).toFixed(4);
}
});
},
...
window.Config = {
baseUrl: "http://156.241.191.27:9501/api/",
socketUrl: "ws://156.241.191.27:9501/"
};
cc._RF.pop();
}, {} ],
...
this.label_content._forceUpdateRenderData(!0);
this.container.height = this.label_content.node.getContentSize().height + 5;
}
});
cc._RF.pop();
}, {} ],
...
for (var i = function(t) {
var i = cc.instantiate(e.emailItem);
i.getComponent("emailItem").setData(n[t], 1);
i.on(cc.Node.EventType.TOUCH_END, function() {
Global.PageMgr.onOpenPage(20);
Global.PageMgr.pages[20].getComponent("EmailDetailPanel").setData(n[t], 1);
...
switch (t) {
case "equipment":
this.scroll_equipment.active = !0;
}
},
showScrolle: function() {
var e = this;
this.container_equipment.removeAllChildren();
for (var t = function(t) {
var n = cc.instantiate(e.selectItem);
n.getComponent(cc.Label).string = e.equipmentdata[t].division_name;
n.on(cc.Node.EventType.TOUCH_END, function() {
e.label_equipment.string = e.equipmentdata[t].division_name;
e.did = e.equipmentdata[t].id;
e.closeScroll();
});
e.container_equipment.addChild(n);
}, n = 0; n < this.equipmentdata.length; n++) t(n);
},
closeScroll: function() {
this.scroll_equipment.active = !1;
},
goEnterGamePanel: function(e, t) {
var n = Global.PageMgr.pages[7].getComponent("GamePanel");
n.bundleId = cc.js.formatStr("1,%s,%s", t.game_package_name, t.game_web_link);
n.datas = t;
if (null != n.selectData) {
n.showScrolle();
n.Panle.active = !1;
n.Panle2.active = !1;
n.Panle3.active = !0;
n.did = -1;
n.scroll_equipment.active = !1;
n.editBox_id.string = "";
n.label_equipment.string = "设备选择:";
n.editBox_name.string = "";
n.lable_name1.string = cc.js.formatStr("%s中官方客服:", t.game_name);
n.lable_name2.string = cc.js.formatStr("%s中我的:", t.game_name);
...
sinceIncrease: function() {
this.dianjiSum += 1;
if (this._availableCoinOne >= this.dianjiSum * (parseInt(1e3 * this.selectData.ticket) / 1e3)) this.lable_sum.string = "" + this.dianjiSum; else {
this.dianjiSum = parseInt(this.lable_sum.string);
Global.PageMgr.showTipPage("门票不足请购买门票");
}
},
...
submitMessage: function() {
"" != this.editBox_id.string ? "" != this.editBox_name.string ? this.dianjiSum <= 0 ? Global.PageMgr.showTipPage("门票不能小于1") : this._availableCoinOne < this.dianjiSum * (parseInt(1e3 * this.selectData.ticket) / 1e3) ? Global.PageMgr.showTipPage("门票不足请购买门票") : -1 != this.did ? this.setUrl() : Global.PageMgr.showTipPage("还未选择设备") : Global.PageMgr.showTipPage("昵称为空") : Global.PageMgr.showTipPage("ID为空");
},
setUrl: function() {
var e = this, t = {
...
this.Panlelist4.active = !1;
this.PanleBG.active = !1;
this.container2.removeAllChildren();
...
this.Panlelist3.active = !1;
this.Panlelist2.active = !1;
this.Panlelist4.active = !0;
this.PanleBG.active = !0;
...
if (200 == t.code) {
for (var n = t.data, i = 0; i < n.length; i++) if ((null == e.selectData || 0 != n[i].is_true) && n[i].game_terminal == e.curType) {
var a = cc.instantiate(e.game_item);
...
var e = this;
Global.ProtocolMgr.queryGameList(1, 1, function(t) {
e.container4.removeAllChildren();
if (200 == t.code) {
for (var n = t.data, i = 0; i < n.length; i++) if (n[i].game_terminal == e.curType && 0 == n[i].is_true) {
var a = cc.instantiate(e.game_item);
a.getComponent("game_item").setData(n[i], e.goEnterGamePanel);
e.container4.addChild(a);
}
} else Global.PageMgr.showTipPage(t.message);
});
},
...
buy: function() {
window.DEFAULT_availableUsdt >= parseInt(this.data.crystal_quantity) ? Global.PageMgr.pages[7].getComponent("GamePanel").goGamePanelUI(this.data, this.propId) : Global.PageMgr.showTipPage(cc.js.formatStr("PMV不足%s", parseFloat(this.data.crystal_quantity).toFixed(1)));
}
});
cc._RF.pop();
}, {} ],
...
e.gold.string = cc.js.formatStr("可用余额:%sPMV", e.goleSum);
e.updataUI();
}
});
},
...
if (e > this.goleSum) Global.PageMgr.showTipPage("PMV不足"); else {
...
if (200 == t.code) {
if (t.data) {
e.label_content.string = t.data.content;
e.label_content._forceUpdateRenderData(!0);
e.container.height = e.label_content.node.getContentSize().height + 5;
}
} else Global.PageMgr.showTipPage(t.message);
});
}
...
queryGetMessage: function(e) {
i.Post("content/getMessage", {
limit: 100,
page: 1
}, e);
},
...
if (void 0 != this.ws && this.ws.readyState == WebSocket.OPEN) {
...
setData: function(e, t) {
var n = this, i = "";
0 == e.state ? i = "信封未读" : 1 == e.state && (i = "信封已读");
try {
cc.loader.loadRes("imgs/" + i, cc.SpriteFrame, function(e, t) {
e || (n.icon_email.spriteFrame = t);
});
} catch (e) {
console.warn(e);
}
this.label_title.string = e.title;
this.label_time.string = 1 == t ? e.time : "";
}
});
cc._RF.pop();
}, {} ],
